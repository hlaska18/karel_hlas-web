...
export function SectionKicker({ no, children }: { no: string; children: ReactNode }) {
  return (
    <p className="flex items-center gap-2.5 text-sm font-semibold uppercase tracking-widest text-accent-700 dark:text-accent-400">
      <span className="font-display text-base font-bold tracking-normal text-accent-700 dark:text-accent-400">
        {no}
      </span>
