    ...
    <section id="top" className="relative overflow-hidden pt-28 sm:pt-32">
      ...
      <div className="container-page grid items-center gap-12 pb-10 lg:grid-cols-[1.1fr_0.9fr] lg:gap-8 lg:pb-14">
        <motion.div variants={container} initial="hidden" animate="show">
          <motion.span
            variants={item}
            className="glass-soft inline-flex items-center gap-2 rounded-full px-3.5 py-1.5 text-xs font-semibold text-accent-700 dark:text-accent-300"
          >
          ...
          <motion.h1
            variants={item}
            className="mt-6 font-display text-5xl font-bold leading-[1.05] tracking-tight text-balance sm:text-6xl"
          >
            {SITE.name}
          </motion.h1>
          ...
          <motion.p
            variants={item}
            className="mt-4 text-xl font-medium text-accent-700 dark:text-accent-400"
          >
            {tr.hero.role}
          </motion.p>
          ...
          <motion.p
            variants={item}
            className="mt-5 max-w-xl text-lg leading-relaxed text-zinc-600 dark:text-zinc-400 text-balance"
          >
            {tr.hero.tagline}
          </motion.p>
