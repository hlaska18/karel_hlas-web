...
export const UKOLY_MAC: UkolMac[] = [
  ...
  },
  {
    ...
    kroky: [
      ...
      "Na obrazovce po Poznámkách není ani stopa – a přesto pod jejich ikonou v Docku tečka zůstala, stejná jako pod Finderem.",
  ...
  },
  {
    ...
    kroky: [
      ...
      "Podívej se do Docku: pod Poznámkami už tečka není. Pod Finderem zůstala, ten běží pořád.",
  ...
  /* ─────────── Aplikace je složka ─────────── */
  {
    ...
    kroky: [
      ...
      "Dvakrát klikni na složku Applications. Pozor, ikona Aplikace v Docku je něco jiného: programy z ní jen spouštíš, složka s nimi je tady.",
