...
export const COURSES: Course[] = [
...

  {
    ...
    items: [
      ...
      {
        month: { cs: "Září – Listopad", en: "September – November" },
        title: {
          cs: "Pokročilé tabulky a datová analýza",
          en: "Advanced spreadsheets & data analysis",
        },
        goal: {
          cs: "Vytvářet tabulky a grafy, filtrovat a třídit data, zpracovávat technická data.",
          en: "Create tables and charts, filter and sort data, and process technical data.",
        },
        topics: {
          cs: [
      ...
      {
        month: { cs: "Listopad – Prosinec", en: "November – December" },
        title: {
          cs: "Počítačové sítě a připojení zařízení",
          en: "Computer networks & connecting devices",
        },
        goal: {
          cs: "Popsat základní principy fungování počítačových sítí, připojit zařízení do sítě, vysvětlit význam IP adresy, DNS a princip sdílení souborů.",
          en: "Describe how computer networks work, connect a device to a network, and explain IP addresses, DNS and file sharing.",
        },
        topics: {
          cs: [
            "Základy sítí – LAN, WAN",
            "IP adresa, DNS, MAC adresa, směrovač",
            "Připojení zařízení a síťové sdílení",
            "Bezpečné připojení a komunikace v síti i na internetu",
          ],
          en: [
            "Network basics — LAN, WAN",
            "IP address, DNS, MAC address, router",
            "Connecting devices & network sharing",
            "Secure connection & communication on a network and the internet",
          ],
        },
        materials: [],
      },
      {
        month: { cs: "Prosinec – Leden", en: "December – January" },
        title: {
          cs: "Základy HTML – tvorba jednoduché webové stránky",
          en: "HTML basics — building a simple web page",
        },
        goal: {
          cs: "Vytvářet jednoduchou statickou webovou stránku s textem, odkazy a obrázky, používat základní HTML značky.",
          en: "Build a simple static web page with text, links and images using basic HTML tags.",
        },
        topics: {
          cs: [
            "HTML značky a struktura dokumentu",
            "Nadpisy a odstavce",
            "Odkazy a obrázky",
            "Formátování",
          ],
      ...
      {
        month: { cs: "Únor", en: "February" },
        title: { cs: "Grafika pro web", en: "Graphics for the web" },
        goal: {
          cs: "Upravovat a připravovat obrázky k použití ve webových stránkách nebo prezentacích, rozlišovat grafické formáty.",
          en: "Edit and prepare images for use on web pages or in presentations and tell graphic formats apart.",
        },
        topics: {
          cs: [
            "Rastrová a vektorová grafika",
            "Úprava velikosti, formátu a rozlišení",
            "Základní úpravy v editoru (GIMP, Canva)",
          ],
          en: [
            "Raster & vector graphics",
            "Adjusting size, format & resolution",
            "Basic edits in an editor (GIMP, Canva)",
          ],
        },
        materials: [],
      },
      {
        month: { cs: "Březen – Duben", en: "March – April" },
        title: {
          cs: "Projekt – tvorba vlastní webové stránky",
          en: "Project — building your own web page",
        },
        goal: {
          cs: "Navrhnout a vytvořit vlastní webovou stránku na zvolené téma pomocí základních HTML prvků.",
          en: "Design and build your own web page on a chosen topic using basic HTML elements.",
        },
        topics: {
          cs: [
            "Návrh struktury stránky",
            "Kombinace textu, obrázků a odkazů",
            "Úprava HTML kódu",
            "Vlastní grafická úprava",
          ],
          en: [
            "Designing the page structure",
            "Combining text, images & links",
            "Editing HTML code",
      ...
      {
        month: { cs: "Duben – Květen", en: "April – May" },
        title: { cs: "Souvislá praxe", en: "Work placement" },
        goal: {
          cs: "Odborná praxe ve firmách.",
          en: "Professional work placement in companies.",
        },
        topics: { cs: [], en: [] },
        materials: [],
      },
      {
        month: { cs: "Květen", en: "May" },
        title: {
          cs: "Elektronické služby a systémy veřejné správy",
          en: "E-government services & systems",
        },
        goal: {
          cs: "Orientovat se v základních elektronických službách státu, přihlásit se pomocí bankovní identity, vědět, kde a jak využít IS veřejné správy.",
          en: "Navigate basic e-government services, sign in with bank identity, and know how to use public administration systems.",
        },
        topics: {
          cs: [
            "Portály veřejné správy (eObčanka, bankovní identita, datové schránky, CzechPOINT)",
            "Informační systémy veřejné správy",
            "Elektronická podání",
            "Základní principy digitalizace státní správy",
          ],
          en: [
            "Public administration portals (eID, bank identity, data boxes, CzechPOINT)",
            "Public administration information systems",
            "Electronic submissions",
            "Basics of digitising public administration",
          ],
        },
        materials: [],
      },
